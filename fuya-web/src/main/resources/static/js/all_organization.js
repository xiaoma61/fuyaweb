	...
	function success(){
		...
		$.ajax({
			...
			success:function(){
				...
				{
					var tr; 
					tr='<div class="content_example"><div class="content_example_left"><img src="../img/y1.jpg" width="100%" alt=""/>刘淑芬<br><img src="../img/star-.png" width="6%"  alt=""/><img src="../img/star-.png" width="6%"  alt=""/><img src="../img/star-.png" width="6%"  alt=""/><img src="../img/star-.png" width="6%"  alt=""/></div><div class="content_example_right">年龄：4'+i+'<br>类型：月嫂<br>籍贯：广东湛江<br>工资：112600/天</div><div class="content_example_more"><a href="#" class="check"><u>查看更多</u></a></div></div>';
					$("#main").append(tr);
				}
